...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~198a4yRSSe0d8bf0bc8c5e96220ffd8f84f4', //your ssid to run bot
    HEROKU: {
    ...
    WORKTYPE : process.env.WORKTYPE || "pablic",
    ...
    SUDO : process.env.SUDO || "94728781314",
